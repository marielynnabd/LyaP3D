...
def get_pairs_single_los(i_los, all_los_table, ang_sep_max, radec_names=['ra', 'dec'], preselect_angsep=False):
...
def compute_pairs(all_los_table, ang_sep_max, radec_names=['ra', 'dec'], ncpu='all', outputfile=None, preselect_angsep=False):
    ...
    with Pool(ncpu) as pool:
        output_get_pairs_single_los = pool.starmap(
            get_pairs_single_los, [[i, all_los_table, ang_sep_max, radec_names, preselect_angsep] for i in range(len(all_los_table))])
